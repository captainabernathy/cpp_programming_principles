...
public:
    ...
    vector(std::initializer_list<double> lst)
        // : sz{lst.size()}, elem{new double[lst.size()]}, cap{lst.size()}
...
// resize this vector to new size... new elems initialized to 0.0
...
// insert d into this vector  vector at v.elem[sz] and increment sz
...
void print_vec(const vector&v, const string& s);
