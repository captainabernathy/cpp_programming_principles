...
// can store elements of any type and use a custom allocator to manage its
// resources if one is provided
//
// NOTE: by default, vectors derived from the template will use the allocator
// that the standard library uses for the type of elements they contain
//
