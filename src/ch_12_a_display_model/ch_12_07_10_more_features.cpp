...
int main()
{
    ...
    try
    {
        ...
        ya.set_color(Color(Color::cyan)); // set color

        // set y Axis label color to dark_red
        ya.label.set_color(Color(Color::dark_red)); // text color
        ...
        sine.set_color(Color(Color::blue)); // change color
        ...
        complex_poly.add(Point(100, 50)); // upper left
        complex_poly.add(Point(200, 50)); // upper right
        ...
        e.set_color(Color(Color::dark_red));
