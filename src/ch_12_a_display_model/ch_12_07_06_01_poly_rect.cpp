...
int main()
{
    ...
    try
    {
        ...
        poly_rect.add(Point(100, 50)); // top left corner at (100,50)
        poly_rect.add(Point(200, 50)); // top right corner at (200,50)
        poly_rect.add(Point(200, 100)); // lower right at (200,100)
        poly_rect.add(Point(100, 100)); // lower left at (100,100)
