...
// library by showing how to build a rectangle with a Rectangle object
...
int main()
{
    ...
    try
    {
        ...
        // build a window
        Simple_window win {top_left, 600, 400, "Canvas #6"};
        ...
        Axis ya {Axis::y, {20, 300}, 200, 10, "y axis"};
