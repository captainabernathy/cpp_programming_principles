...
// library by showing how to manipulate the properties of Text objects
...
int main()
{
    ...
    try
    {
        ...
        // build a window
        Simple_window win {top_left, 600, 400, "Canvas #9"};
        ...
        // t.set_font(Graphics_lib::Font(Graphics_lib::Font::times_bold));
