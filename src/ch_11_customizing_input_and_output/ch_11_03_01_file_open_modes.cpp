...
int main()
{
    ...
    // for writing, the operating system will crate an empty file with the
    ...
    // NOTE: will fail if the file does not exist
...

    {
        ...
        if (!ifs)
            cerr << "failed to open file: \"no-file-of-this-name\" for "
                << "reading\n";
    }
